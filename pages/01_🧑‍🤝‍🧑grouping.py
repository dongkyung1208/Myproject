...
# ---------------------------
st.markdown("---")
# type을 xlsx, xls로 변경하여 엑셀 파일만 받도록 설정
uploaded_file = st.file_uploader("📂 1학년 학생 명단 엑셀(Excel) 파일을 업로드해주세요.", type=['xlsx', 'xls'])
...
if uploaded_file is not None:
    ...
    st.info("👆 위쪽에 '2026. 구산고 학적 현황표.xlsx' 파일을 드래그해서 올려주세요.")
